...
enum CSG_MESH_CHECK
    {
        ...
        CSG_MESH_CHECK_DUP_POINTS	= 0x1,
        CSG_MESH_CHECK_BAD_INDEX	= 0x2,
        CSG_MESH_CHECK_UNUSED_POINT	= 0x4,
        CSG_MESH_CHECK_OPENINGS	= 0x8,
        CSG_MESH_CHECK_PLANES	= 0x10,
        CSG_MESH_CHECK_DUP_PLANES	= 0x20,
        CSG_MESH_CHECK_VOIDPOLYS	= 0x40,
        CSG_MESH_CHECK_SELFINTERSECT	= 0x80
    } 	CSG_MESH_CHECK;
